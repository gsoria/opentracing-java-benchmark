...
public class BenchmarkSimpleServletThroughput {
        ...
        public void setup() {
            ...
            try {
                DeploymentInfo servletBuilder = Servlets.deployment()
                        .setClassLoader(BenchmarkSimpleServletThroughput.class.getClassLoader())
                        .setContextPath("/ui")
                ...
                PathHandler path = Handlers.path(
                        Handlers.resource(new ClassPathResourceManager(BenchmarkSimpleServletThroughput.class.getClassLoader(), "webapp")))
